...
public class PersonServiceImplProxy implements com.bcj.soapexample.personcrud.service.PersonServiceImpl {
  private String _endpoint = null;
  private com.bcj.soapexample.personcrud.service.PersonServiceImpl personServiceImpl = null;
  ...
  private void _initPersonServiceImplProxy() {
    try {
      personServiceImpl = (new com.bcj.soapexample.personcrud.service.PersonServiceImplServiceLocator()).getPersonServiceImpl();
  ...
  public com.bcj.soapexample.personcrud.service.PersonServiceImpl getPersonServiceImpl() {
    if (personServiceImpl == null)
      _initPersonServiceImplProxy();
