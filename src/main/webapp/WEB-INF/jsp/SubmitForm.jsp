	...
	$(document).ready(function() {
        ...
        $.ajax({
            ...
            success : function(callback){
            	alert("Response: FirstName: "+callback.firstName+"  LastName: "+callback.lastName+"  DOB: "+callback.dob+"  Email: "+callback.email+"  Phone: "+callback.phone+"  Plan: "+callback.plan+"  SSN: "+callback.ssn);
                $(this).html("Success!");
            },
            error : function(){
                $(this).html("Error!");
...
<body>
<form:form commandName="member" action="submitForm.web" method="post" id="submitForm">     
	    ...
	    <fieldset style="width: 300px;">
	        ...
	        <ol>
	            ...
	            <li>
	                <p><label for=name>Plan</label>
	                <form:input path="plan" type="text" required="true" /></p>
	            </li>
	            <li>
	                <p><label for=name>SSN</label>
	                <form:input path="ssn" type="password" required="true" /></p>
	            </li>
	         </ol>
	    </fieldset>
